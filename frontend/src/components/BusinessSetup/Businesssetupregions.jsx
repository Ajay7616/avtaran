...
function BusinessSetupRegions() {
  return (
    <section className="py-[100px]" id="business-setup-regions">
      <div className="wrap">
        <div className="max-w-[1200px] mb-14">
          ...
          <h2 className="text-teal-900 text-[clamp(2rem,4vw,2.7rem)] mt-4">
            Business set-up support, region by region
          </h2>
        </div>
                ...
                {r.countries.map((c) => (
                  <div className="intl" key={c.name}>
                    <img
                      ...
                      alt={`${c.name} flag`}
                      className="w-10 h-auto object-contain shrink-0 rounded-sm"
                    />
...
export default BusinessSetupRegions;