...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        "grad-gold": "linear-gradient(135deg,#B8860B 0%,#D4A017 45%,#F2C94C 100%)",
        "grad-teal": "linear-gradient(150deg,#0E4D66 0%,#0B2E3D 100%)",
        "grad-hero": "linear-gradient(165deg,#FFFFFF 0%,#FDFEFF 55%,#F4F8FA 100%)",
        ...
        "grid-pattern": "linear-gradient(rgba(18,60,74,.05) 1px,transparent 1px),linear-gradient(90deg,rgba(18,60,74,.05) 1px,transparent 1px)",
      },
      boxShadow: {
        "brand-sm": "0 1px 3px rgba(11,46,61,.08),0 8px 24px rgba(11,46,61,.07)",
